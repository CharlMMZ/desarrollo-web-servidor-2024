...
<body>
    <div class="container">
        <!--Todo va en un div clase container-->
        <?php
                ...
                if($tmp_titulo == "") {
                    ...
                    if (strlen($tmp_titulo)>60) {
                        ...
                        if (!preg_match($patron, $tmp_titulo)) {
                            $err_titulo = "El título solo puede contener letras, números y espacios en blanco";
                        }else{
                            $titulo=$tmp_titulo;
                        }
                    }
            ...
            if (strlen($tmp_descripcion)>255) {
                ...
                if (!preg_match($patron, $tmp_descripcion)) {
                    $err_descripcion = "El título solo puede contener letras, números, espacios en blanco, puntos y comas";
                }else{
            ...
            if($tmp_fecha_lanzamiento == "") {
                ...
                if(!preg_match($patron,$tmp_fecha_lanzamiento)) {
                    ...
                    if ($anno < 1947) {
                        $err_fecha_lanzamiento = "El año no puede ser anterior al 1947";
                    }else{
                        $anno_actual = date("Y");
                        $mes_actual = date("m");
                        $dia_actual = date("d");
